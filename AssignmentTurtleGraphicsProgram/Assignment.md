...
1. [x] “penup” (1 mark)
2. [x] “pendown” (1 mark1)
3. [x] “turnleft” (2 marks) (1 mark only if no parameter)
4. [x] “turnright” (2 marks) (1 mark only if no parameter)
5. [x] “forward” (2 marks) (1 mark only if no parameter)
6. [x] “backward” (2 marks) (1 mark only if no parameter)
7. [x] at least four colour command (such as “red”) (3 marks)
8. [x] “reset” move the turtle to the initial position and pointing down (1 mark)
9. [x] “clear” clears display, turtle stays in the same position (1 mark)
